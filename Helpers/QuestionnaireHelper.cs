...
namespace Generic.Helpers.Questionnaire
{
    ...
    public static class LevelType
    {
        ...
        public const int PARTNUMBER_LEVEL_L2L = 6;
    }
    ...
    public static class CMS
    {
        ...
        public const string REDIRECT_PAGE_TITLE = "REDIRECT_PAGE_TITLE";
        public const string REDIRECT_PAGE_SUBTITLE = "REDIRECT_PAGE_SUBTITLE";
        public const string REDIRECT_PAGE_PANEL_ONE = "REDIRECT_PAGE_PANEL_ONE";
        public const string REDIRECT_PAGE_PANEL_TWO = "REDIRECT_PAGE_PANEL_TWO";
        public const string REDIRECT_PAGE_HEADER = "REDIRECT_PAGE_HEADER";
        public const string REDIRECT_PAGE_HEADER_TEXT = "REDIRECT_PAGE_HEADER_TEXT";
        ...
        public const string REDIRECT_CONFIRMATION_PAGE_PANEL_ONE = "REDIRECT_CONFIRMATION_PAGE_PANEL_ONE";
        public const string REDIRECT_CONFIRMATION_PAGE_PANEL_TWO = "REDIRECT_CONFIRMATION_PAGE_PANEL_TWO";
        public const string REDIRECT_CONFIRMATION_PAGE_HEADER = "REDIRECT_CONFIRMATION_PAGE_HEADER";
        public const string REDIRECT_CONFIRMATION_PAGE_HEADER_TEXT = "REDIRECT_CONFIRMATION_PAGE_HEADER_TEXT";
        public const string REDIRECT_CONFIRMATION_PAGE_PREVIOUS_TEXT = "REDIRECT_CONFIRMATION_PAGE_PREVIOUS_TEXT";
        public const string REDIRECT_CONFIRMATION_PAGE_NEXT_TEXT = "REDIRECT_CONFIRMATION_PAGE_NEXT_TEXT";
