...
namespace Generic.Helpers
{
    ...
    public class EvernoteAuthorizer
    {
        ...
        /// </summary>
        public static AsyncEvernoteAuthorizer AsyncEvernoteAuthorizer { get; set; }
        ...
        public static RequestToken GetRequestToken(string callbackUri)
        {
        ...
        /// <returns></returns>
        public static string BuildAuthorizeUrl(RequestToken token)
        {
        ...
        /// <returns></returns>
        public static EvernoteCredentials ParseAccessToken(string oauth_verifier, RequestToken token)
        {
