...
namespace Generic
{
    ...
    {
        /// <summary> 
        ///Set up the view locations (including the temp locations we will build to) 
        ...
        public EmbeddedResourceViewEngine()
        {
            ...
            {
                "~/Areas/{2}/Views/{1}/{0}.cshtml",//client Specific-Tested in this Demo! 
                "~/tmp/Areas/{2}/Views/{1}/{0}.cshtml",//Pick up generic if no client 
            };
            
            AreaPartialViewLocationFormats =new[]
            {
                "~/Areas/{2}/Views/Shared/{0}.cshtml",//Client Specific – not used in demo 
                "~/tmp/Areas/{2}/Views/Shared/{0}.cshtml" //Pick up generic if no client 
            };
