...
namespace Generic
{
    ...
    public partial class hs3MVCMTQa2Entities : DbContext
    {
        ...
        public virtual DbSet<partnerSpreadsheetDataLoad> partnerSpreadsheetDataLoads { get; set; }
        ...
        public virtual ObjectResult<Nullable<decimal>> pr_addIterateObjection(string description, string code, Nullable<int> sortOrder, Nullable<bool> active, Nullable<int> enterprise)
        {
            var descriptionParameter = description != null ?
                new ObjectParameter("description", description) :
                new ObjectParameter("description", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("pr_addIterateObjection", descriptionParameter, codeParameter, sortOrderParameter, activeParameter, enterpriseParameter);
        }
    
        public virtual int pr_archiveIterateObjection(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_archiveIterateObjection", idParameter);
        }
    
        public virtual ObjectResult<pr_getIterateObjection_Result> pr_getIterateObjection(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_getIterateObjection_Result>("pr_getIterateObjection", idParameter);
        }
    
        public virtual ObjectResult<pr_getIterateObjectionAll_Result> pr_getIterateObjectionAll(Nullable<int> enterprise)
        {
            var enterpriseParameter = enterprise.HasValue ?
                new ObjectParameter("enterprise", enterprise) :
                new ObjectParameter("enterprise", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_getIterateObjectionAll_Result>("pr_getIterateObjectionAll", enterpriseParameter);
        }
    
        public virtual ObjectResult<pr_getIteratePartnerPerson4_Result> pr_getIteratePartnerPerson4(Nullable<int> person)
        {
            var personParameter = person.HasValue ?
                new ObjectParameter("person", person) :
                new ObjectParameter("person", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_getIteratePartnerPerson4_Result>("pr_getIteratePartnerPerson4", personParameter);
        }
    
        public virtual int pr_modifyIterateObjection(Nullable<int> id, string description, string code, Nullable<int> sortOrder, Nullable<bool> active, Nullable<int> enterprise)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_modifyIterateObjection", idParameter, descriptionParameter, codeParameter, sortOrderParameter, activeParameter, enterpriseParameter);
        }
    
        public virtual int pr_modifyIteratePerson(Nullable<int> id, string firstname, string lastname, string title, string email, string phone, string fax, Nullable<bool> active, Nullable<System.DateTime> dateAdded, Nullable<System.DateTime> lastModified, Nullable<int> iteratePartner, Nullable<int> lastContact, Nullable<System.DateTime> lastContactDate, Nullable<int> previousContact, Nullable<System.DateTime> previousContactDate, Nullable<int> nextAction, Nullable<System.DateTime> nextActionDate, Nullable<bool> notes, Nullable<int> objection)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
            ...
            var objectionParameter = objection.HasValue ?
                new ObjectParameter("objection", objection) :
                new ObjectParameter("objection", typeof(int));
        ...
        public virtual ObjectResult<Nullable<int>> pr_addPartnerSpreadsheetDataLoad(string partner_internal_id, string partner_sap_id, string partner_duns_number, string partner_name, string partner_address_one, string partner_address_two, string partner_city, string partner_state, string partner_zipcode, string partner_country, string partner_poc_first_name, string partner_poc_last_name, string partner_poc_title, string partner_poc_phone_number, string partner_poc_email_address, string ro_first_name, string ro_last_name, string ro_email, Nullable<System.DateTime> date_loaded, Nullable<int> enterprise, Nullable<int> partnertype, Nullable<int> touchpoint, Nullable<int> person, Nullable<int> partnerSpreadsheetDataLoadStatus, string loadGroup, Nullable<System.DateTime> dueDate, Nullable<int> group)
        {
            ...
            var partner_duns_numberParameter = partner_duns_number != null ?
                new ObjectParameter("partner_duns_number", partner_duns_number) :
                new ObjectParameter("partner_duns_number", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<int>>("pr_addPartnerSpreadsheetDataLoad", partner_internal_idParameter, partner_sap_idParameter, partner_duns_numberParameter, partner_nameParameter, partner_address_oneParameter, partner_address_twoParameter, partner_cityParameter, partner_stateParameter, partner_zipcodeParameter, partner_countryParameter, partner_poc_first_nameParameter, partner_poc_last_nameParameter, partner_poc_titleParameter, partner_poc_phone_numberParameter, partner_poc_email_addressParameter, ro_first_nameParameter, ro_last_nameParameter, ro_emailParameter, date_loadedParameter, enterpriseParameter, partnertypeParameter, touchpointParameter, personParameter, partnerSpreadsheetDataLoadStatusParameter, loadGroupParameter, dueDateParameter, groupParameter);
        }
    
        public virtual ObjectResult<pr_addQuestionnaireQuestionnaireCMS_Result> pr_addQuestionnaireQuestionnaireCMS(Nullable<int> questionnaire, Nullable<int> questionnaireCMS, string text, string link, byte[] doc, string uploadedFileType)
        {
            var questionnaireParameter = questionnaire.HasValue ?
                new ObjectParameter("questionnaire", questionnaire) :
                new ObjectParameter("questionnaire", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<pr_addQuestionnaireQuestionnaireCMS_Result>("pr_addQuestionnaireQuestionnaireCMS", questionnaireParameter, questionnaireCMSParameter, textParameter, linkParameter, docParameter, uploadedFileTypeParameter);
        }
        ...
        public virtual int pr_modifyQuestionnaireQuestionnaireCMS(Nullable<int> questionnaire, Nullable<int> questionnaireCMS, string text, string link, byte[] doc, string uploadedFileType)
        {
            var questionnaireParameter = questionnaire.HasValue ?
                new ObjectParameter("questionnaire", questionnaire) :
                new ObjectParameter("questionnaire", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("pr_modifyQuestionnaireQuestionnaireCMS", questionnaireParameter, questionnaireCMSParameter, textParameter, linkParameter, docParameter, uploadedFileTypeParameter);
        }
